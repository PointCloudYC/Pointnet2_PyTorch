...
class PSNet3DSemSeg(data.Dataset):
    def __init__(self, num_points, train=True, download=False, data_precent=1.0):
        ...
        for f in all_files:
            data, label = _load_data_file(os.path.join(BASE_DIR, f)) # 1000x4096x9, 1000x4096
...
if __name__ == "__main__":
    dset = PSNet3DSemSeg(16, "./", train=True)
    print(dset[0])
    print(len(dset))
